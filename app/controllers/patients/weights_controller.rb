class Patients::WeightsController < ApplicationController
#  before_action :set_weight, only: [:show, :edit, :update, :destroy]
  ...
  def create
    ...
    respond_to do |format|
      if @weight.save
        format.html { redirect_to @patient, notice: 'Weight was successfully created.' }
  ...
  private
    ...
    def weight_params
      params.require(:weight).permit(:kilograms, :current, :patient_id)
    end
end
