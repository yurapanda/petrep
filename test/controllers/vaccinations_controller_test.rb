...
class VaccinationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create vaccination" do
    assert_difference('Vaccination.count') do
      post vaccinations_url, params: { vaccination: { description: @vaccination.description, name: @vaccination.name } }
    end
  ...
  test "should update vaccination" do
    patch vaccination_url(@vaccination), params: { vaccination: { description: @vaccination.description, name: @vaccination.name } }
