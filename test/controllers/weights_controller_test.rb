...
class WeightsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create weight" do
    assert_difference('Weight.count') do
      post weights_url, params: { weight: { current: @weight.current, kilograms: @weight.kilograms, patient_id: @weight.patient_id } }
    end
  ...
  test "should update weight" do
    patch weight_url(@weight), params: { weight: { current: @weight.current, kilograms: @weight.kilograms, patient_id: @weight.patient_id } }
